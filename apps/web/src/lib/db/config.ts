...
// Force pg to parse TIMESTAMP WITHOUT TIME ZONE (OID 1114) as UTC Date objects.
// This ensures database timestamps generated by NOW() or CURRENT_TIMESTAMP
// are parsed in UTC instead of local timezone, preventing offset errors on client.
