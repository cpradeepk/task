...
interface BugRow  {
  ...
  server_logs: string | null          // Server-side logs and error traces (optional)
  ...
  return withRetry(async () => {
    ...
    await query<any>(
      ...
      [
        ...
        bug.serverLogs || null,             // Optional: Server-side logs
        bug.frontendLogs || null,           // Optional: Frontend console logs
